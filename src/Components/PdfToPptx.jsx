...
const PdfToPptx = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append('outputFormat', 'pptx'); // Hardcoded for this component
  ...
  return (
    ...
    <div className="pdf-to-pptx container mt-5">
      <h2 className="text-center mb-4">PDF to PPTX</h2>
      <div className="card shadow mx-auto" style={{ maxWidth: '500px' }}>
        <div className="card-body">
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="btn btn-primary w-100">Convert to PPTX</button>
          </form>
          {downloadUrl && (
            <div className="mt-3 text-center">
              <button onClick={handleDownload} className="btn btn-success">Download PPTX</button>
            </div>
          )}
