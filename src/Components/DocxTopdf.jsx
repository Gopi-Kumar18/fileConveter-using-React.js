...
const DocxToPdf = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append('outputFormat', 'pdf'); //This is hardcoded output format.. 
  ...
  return (
    ...
    <div className="docx-to-pdf container mt-5">
      <h2 className="text-center mb-4">DOCX to PDF</h2>
      <div className="card shadow mx-auto" style={{ maxWidth: '500px' }}>
        <div className="card-body">
          <form onSubmit={handleSubmit}>
            <div className="mb-3">
              <label htmlFor="fileInput" className="form-label">Select DOCX File</label>
              <input type="file" className="form-control" id="fileInput" accept=".docx" onChange={handleFileChange} required />
            </div>
